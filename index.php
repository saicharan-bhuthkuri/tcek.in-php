            ...
            <div class="container hero-grid">
                <div class="hero-content">
                    <div class="trust-badge">
                        <i class="fas fa-check-circle"></i> NAAC 'B++' Grade & Autonomous
                    </div>
                    <h1>Empowering Future <br><span>Innovators</span></h1>
                    <p>
                        Trinity College of Engineering and Technology is a premier institution aiming to impart
                        knowledge by attracting experienced faculty and providing the best infrastructural facilities.
                        We view collaboration with industry as critical for preparing successful trendsetting
                        technocrats.
                    </p>
                    <div class="cta-buttons">
                        <a href="admission.php" class="btn btn-primary">Admissions Open</a>
