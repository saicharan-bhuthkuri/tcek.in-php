...
<head>
    ...
    <title>Service Rules - Trinity College of Engineering & Technology</title>
...
<body>
    ...
    <section class="page-header">
        <h1>Service Rules</h1>
        <p><a href="about-us.php" style="color: #fff; text-decoration: underline;">About Us</a> / Service Rules</p>
    </section>

    <!-- Main Content -->
    <section class="content-section">
        <h2>Content Coming Soon...</h2>
        <p>We are currently updating our service rules. Please check back later.</p>
