...
<head>
    ...
    <title>EEE Lecture Notes - E-CONTENT</title>
...
<!-- Page Header -->
    <section class="page-header" style="margin-bottom: 0;">
        <h1>EEE Lecture Notes</h1>
        <p><a href="e-content.php" style="color: #fff; text-decoration: underline;">E-CONTENT</a> / EEE Notes</p>
    </section>
        ...
        <div class="container">
            ...
            <div id="notesContainer">
                ...
                <div class="academic-year-section">
                    ...
                    <div class="notes-grid">
                        <div class="note-card">
                            <div class="subject-name">Subject 1 (Placeholder)</div>
                            <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Notes</a>
                        </div>
                        <!-- Add more placeholders as needed -->
                        <div class="note-card">
                            <div class="subject-name">Subject 2 (Placeholder)</div>
                            <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Notes</a>
                        </div>
                        <div class="note-card">
                            <div class="subject-name">Subject 3 (Placeholder)</div>
                            <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Notes</a>
                        </div>
                        <div class="note-card">
                            <div class="subject-name">Subject 4 (Placeholder)</div>
                            <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Notes</a>
                        </div>
                        <div class="note-card">
                            <div class="subject-name">Subject 5 (Placeholder)</div>
                            <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Notes</a>
                        </div>
                    </div>
