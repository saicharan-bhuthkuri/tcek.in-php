...
<html lang="en">
<head>
    <title>Criteria 3 - Research, Innovations & Extension - TCEK</title>
    ...
    <div class="container-box">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.2.2</span>
                <h3 class="criteria-title">Seminars / Workshops</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.3.2</span>
                <h3 class="criteria-title">Conferences</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.4.1</span>
                <h3 class="criteria-title">Extension Activities List</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.4.2</span>
                <h3 class="criteria-title">Extension Activities Recognition</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.4.3</span>
                <h3 class="criteria-title">Organized Extension Activities Documents</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">3.5.1</span>
                <h3 class="criteria-title">MoUs</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
