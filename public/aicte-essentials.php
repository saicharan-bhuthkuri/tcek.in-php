...
<body>
    ...
    <header class="page-header-section">
        ...
        <p>Mandatory Requirements & Compliance Documents</p>
    </header>
    ...
    <div class="container-box">
        ...
        <ul class="doc-list">
            ...
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/30.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">30.</span>
                    <span class="doc-title">Vehicle Parking</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/31.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">31.</span>
                    <span class="doc-title">General Notice Board and Departmental Notice Boards</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/32.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">32.</span>
                    <span class="doc-title">Display of Course(s) and Approved Intake in the Institution at the entrance of the Institution</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/33.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">33.</span>
                    <span class="doc-title">Establishment of 24x7 women helpline number and a security system in the campus for providing safety to students and female faculty and non-teaching faculty.</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/34.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">34.</span>
                    <span class="doc-title">Establishment of platform or hiring counsellors for seeking help and guidance w.r.t psychological counselling related to Mental Health for Students, faculty and non-teaching faculty.</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/35.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">35.</span>
                    <span class="doc-title">Implementation of mandatory Internship Policy for Students</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/36.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">36.</span>
                    <span class="doc-title">As per NEP, every Institution shall have inbuilt mechanism for Social and Emotional Learning A crucial component of Education.</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/37.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">37.</span>
                    <span class="doc-title">Internship shall be made compulsory for all final year students of AICTE approved Institutes/Universities.</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/38.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">38.</span>
                    <span class="doc-title">The electives mandatorily through SWAYAM (MOOCS Platform)</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/39.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">39.</span>
                    <span class="doc-title">The AICTE approved institutions shall evolve a mechanism for earning credits through 'Skilling' based courses offered by Skill India, Ministry of Skill Development and Entrepreneurship</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/40.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">40.</span>
                    <span class="doc-title">Language Laboratory (for institutions having Diploma and Degree Programs)</span>
                </a>
            </li>
            <li class="doc-item">
                <a href="assets/Essentials-AICTE/41.pdf" target="_blank" class="doc-link">
                    <span class="doc-icon"><i class="fas fa-file-pdf"></i></span>
                    <span class="doc-number">41.</span>
                    <span class="doc-title">Establishment of Research & Develop rent (R&D) Cell including Climate Cell in Institutions running Undergraduate (UG) and postgraduate (PG) courses in Engineering & Technology, Management and Computer Application institutions.</span>
                </a>
            </li>
        </ul>
    </div>
