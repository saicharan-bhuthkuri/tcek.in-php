...
<html lang="en">
<head>
    <title>AIML Department - TCEK</title>
...
<body>
    ...
    <section class="dept-header">
        ...
        <p><a href="departments.php" style="color: #fff; text-decoration: underline;">Departments</a> / AIML</p>
    </section>
    ...
    <div class="container" style="padding: 30px 20px;">
        ...
        <div class="content-box">
            ...
            <div class="hod-card">
                <img src="assets/Dept/Hod-aiml.jpg" alt="G ANJANEYULU" class="hod-img" onerror="this.src='assets/Dept/Hod-aiml.jpg'"> <!-- Fallback to EEE HOD if AIML not found temp -->
                <div class="hod-info">
