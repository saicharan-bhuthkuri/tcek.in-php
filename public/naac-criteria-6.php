...
<html lang="en">
<head>
    <title>Criteria 6 - Governance, Leadership & Management - TCEK</title>
    ...
    <div class="container-box">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">6.2.2</span>
                <h3 class="criteria-title">Implementation of E-Governance</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">6.3.2</span>
                <h3 class="criteria-title">Financial Support to Teachers</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">6.3.3</span>
                <h3 class="criteria-title">Professional Development Programs</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
                ...
                <li class="doc-item">
                    <a href="assets/naac/6.3.3(4).pdf" target="_blank" class="doc-link">
                        <span>6.3.3(4) Professional Development program for AY 2018-19</span>
                    </a>
                </li>
                <li class="doc-item">
                    <a href="assets/naac/6.3.3(5).pdf" target="_blank" class="doc-link">
                        <span>6.3.3(5) Professional Development program for AY 2017-18</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">6.5.2</span>
                <h3 class="criteria-title">Internal Quality Assurance System (IQAC)</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
                    <a href="assets/naac/6.5.2(1).pdf" target="_blank" class="doc-link">
                        <span>6.5.2(1) MInutes of IQAC</span>
                    </a>
                </li>
                <li class="doc-item">
                    <a href="assets/naac/6.5.2(2).pdf" target="_blank" class="doc-link">
                        <span>6.5.2(2) Feedback analysis and Action taken report</span>
                    </a>
                </li>
                <li class="doc-item">
                    <a href="assets/naac/6.5.2(3).pdf" target="_blank" class="doc-link">
                        <span>6.5.2(3) E-Copies of Collaborations with other Institution</span>
                    </a>
                </li>
                <li class="doc-item">
                    <a href="assets/naac/6.5.2(4).pdf" target="_blank" class="doc-link">
                        <span>6.5.2(4) List of collabrative activities with other institution</span>
                    </a>
                </li>
                 <li class="doc-item">
                    <a href="assets/naac/6.5.2(5).pdf" target="_blank" class="doc-link">
                        <span>6.5.2(5) ISO Certificate</span>
                    </a>
                </li>
            </ul>
        </div>
