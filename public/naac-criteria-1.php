...
<html lang="en">
<head>
    <title>Criteria 1 - Curricular Aspects - TCEK</title>
    ...
    <div class="container-box">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.1.1</span>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.2.1</span>
                <h3 class="criteria-title">Certificate/ Add- on Programs</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.2.2</span>
                <h3 class="criteria-title">Students Enrolled in Certificate Programs</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.3.1</span>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.3.2</span>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
        ...
        <div class="criteria-card">
            <div class="criteria-header">
                <span class="criteria-badge">1.4.1</span>
                <h3 class="criteria-title">Feedback System</h3>
            </div>
            <ul class="doc-list">
                <li class="doc-item">
